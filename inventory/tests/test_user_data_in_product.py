...
class TestUserData(BaseInventoryTestCase):
    ...
    def setUp(self):
        ...
        self.full_live_server_url = f'{self.live_server_url}/books/product'
    ...
    def test_getting_user_data_with_error_404(self):
        ...
        response = self.client.get(f'{self.live_server_url}/inventory/widgets/user_data/other_product/')
